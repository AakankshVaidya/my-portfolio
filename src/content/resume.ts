...
export const experience = [
  {
    ...
    role: "Group Tutor, Statistical Methods in Economics",
    company: "Dartmouth College Academic Skill Center",
    description:
      "Led weekly group sessions for up to 50 students on regression analysis, hypothesis testing, and econometric reasoning. Developed summary sheets and review materials with faculty to support midterm and final exam preparation.",
    skills: ["Statistics", "Teaching", "Economics"],
  },
  {
  ...
  },
  {
    ...
    company: "Dartmouth College ISMP",
    description:
      "Mentored a cohort of 10 incoming international students and led programming for 160+ students during pre-orientation, coordinating logistics and facilitating a welcoming transition experience.",
    skills: ["Mentorship", "Leadership", "Event Planning"],
  },
];
